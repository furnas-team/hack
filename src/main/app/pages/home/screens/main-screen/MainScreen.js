      ...
      <div className="main-screen">
        ...
        <div className="main-screen__buttons">
          <UniversalLink href="#choose-person"
                         className="main-screen__documents-list-button"
                         noStyle={true}>
            <Button>Список документов</Button>
          </UniversalLink>
          <UniversalLink href={createVisaApplicationFormRoute()}
                         className="main-screen__visa-application-form-button"
                         noStyle={true}>
            <Button>Заполнение анкеты</Button>
          </UniversalLink>
        </div>
